...
By allowing flexibility for individual nodes to evolve as they see fit, but still be part of the collective, and ideally donating back those non-standard or proprietary components back to the collective, we create a primary mechanism of generating new components. This mechanism will help generate and proliferate new components ONLY when they are needed, and based on a concrete need, rather than on hypothetical use cases.
